...
import { playerFacingMapSrc, pushPlayerStateToServer } from './tokens.js';
...
export function forceSyncToMapDisplay() {
  ...
  ch.postMessage({
    type: 'fog-update',
    // On a split map the projector draws the players' copy. Width/height stay
    // the GM image's — that is the space the mask and crop are measured in.
    imageSrc: playerFacingMapSrc() || S.fogImage.src,
