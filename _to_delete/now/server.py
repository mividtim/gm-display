    ...
    def do_GET(self):
        ...
        if parsed.path == '/api/player_state':
            ...
            if payload:
                ...
                # Substituting here rather than trusting the GM page to push the
                # right image means a remote browser cannot be handed the GM's
                # copy even if the page that pushed the frame was wrong.
                if variant and self.is_remote():
